...
for basepath in $(ls -Sr lwb_k/*.txt.1.intohylo); do
    ...
    for n in $(seq 1 10); do
        ...
        echo $n
        out_log="klogsZip/${base}.txt.${n}.intohylo_output.log"
        time_log="klogsZip/${base}.txt.${n}.intohylo_time.log"
...
#         file="lwb_k/${base}.txt.${n}.intohylo"
#         echo $n
#         out_log="klogsTree/${base}.txt.${n}.intohylo_output.log"
#         time_log="klogsTree/${base}.txt.${n}.intohylo_time.log"
